...
export default function ViewQuotation() {
    ...
    const co = {
        ...
        gstin: cleanStr(doc?.companyGst || doc?.company_gst || settings?.branches?.[0]?.gst || TV.gstin),
        address: cleanStr(doc?.companyAddress || doc?.company_address || settings?.branches?.[0]?.address || TV.address),
